...
- [ ] 로그인 (데모 계정 진입 포함)
- [ ] 새 프로젝트 생성 진입
- [ ] 상품 정보 입력 (최소 필드: 상품명, 카테고리, 키워드, 타깃, 톤앤매너, 무드, 플랫폼, 추가 제작 요청)
- [ ] 상품 이미지 업로드 (최적화 없이 원본 업로드만)
- [ ] AI 13섹션 생성 (mock fallback 허용)
- [ ] 모바일 캔버스에 13섹션 렌더링
- [ ] 섹션 1개 문구 직접 수정
- [ ] AI 편집 도우미로 섹션 1개 다시쓰기 → 적용하기
- [ ] 프로젝트 저장 및 다시 불러오기
- [ ] 플랫폼 1종 기준 이미지 생성 + ZIP 다운로드

## 1. 프로젝트 기본 구조

- [ ] Claude Design 산출물 검토 및 화면별 라우트 매핑
- [ ] 디자인 색상/타이포/spacing 토큰 globals.css 반영
- [ ] 디자인 기준 누락 shadcn/ui 컴포넌트 추가 설치
- [ ] 라우트 구조 정리
- [ ] 공통 레이아웃 구성
- [ ] shadcn/ui 컴포넌트 정리
- [ ] 공통 타입 정의
